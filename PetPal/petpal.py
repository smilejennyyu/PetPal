...
class Pet:
    ...
    def __init__(self, kind="dog"):
        ...
        self.__dict__["_v"] = {
            ...
            "color": "golden", "hungry": False, "mood": "happy",
        }
...
class _Stage:
    ...
    def _button(self, parent, text, cmd, color):
        return tk.Button(parent, text=text, command=cmd, font=self.F(10, True),
                         bg=color, fg="white", relief="flat", padx=14, pady=5,
                         activebackground=_shade(color, 0.92),
    ...
    def _draw(self):
        ...
        c.delete("all")
        self._draw_scene()
        for pet in sorted(self.pets, key=lambda p: p._v["tile"]):
            self._draw_pet(pet)
